...
import { CForm, CFormGroup, CRow, CCol, CButton } from "@coreui/react";
...
class InitialProjectUploadDocs extends Component {
  state = {
    filename: "",
    file_id: "",
  ...
  downloadFile = async (e) => {
    this.setState(
      ...
      () => {
        foxApi
          .downloadDocument(this.state.file_id)
          .then((blob) => {
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(WithLoading(InitialProjectUploadDocs));
