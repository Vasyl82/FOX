...
class DocumentDetail extends Component {
  ...
  handleSubmit = async event => {
    ...
    await foxApi.patchEntityWithFiles('documents', this.props.match.params.doc_id, formData)
      .then(() => {
            ...
            <CCardBody>
              <WithLoadingSpinner loading={this.props.loading} >
                <CForm onSubmit={this.handleSubmit}>
                  ...
                  <CFormGroup>
                    <CButton shape="pill" type="submit" color="dark" variant="outline" disabled={this.props.submitting} block><SubmitSpinner submitting={this.props.submitting} />Update Document</CButton>
                  </CFormGroup>
                  {error
                    ? <p>{error}</p>
                    : null
